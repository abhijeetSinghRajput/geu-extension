...
const IdCard = () => {
  ...
  return (
    <div className="mx-auto grid grid-cols-1 p-1 sm:p-2 gap-0.5 w-max bg-white text-black">
      <IdCardFront
        campus={campus}
        idCard={idCard}
...
const IdCardFront = ({ idCard, className, campus }) => {
  const banner = campus === "hill" ? gehuBanner : geuBanner;
      ...
      <table className="w-full h-full  border-collapse">
        <tbody>
          ...
          <tr>
            ...
            {/* Student Photo */}
            <td className="w-[96px] p-2">
              <div className="w-[20] h-[96px] bg-gray-50 flex items-center justify-center">
                {idCard?.Photo ? (
                  <img
                    src={idCard?.Photo}
                    alt="Student"
              ...
              <div className="space-y-1">
                ...
                <div className="space-y-0.5 ">
                  <div className="flex gap-2">
                    <span className="font-bold w-[80px]">ADMISSION NO.</span>
                    <span className="ml-1">{idCard?.StudentID}</span>
                  </div>

                  <div className="flex gap-2">
                    <span className="font-bold w-[80px]">BATCH</span>
        ...
        <tbody>
          ...
          <tr>
            <td className="p-2 align-top">
              <div className="space-y-1">
                <div className="flex">
                  <span className="font-bold w-[80px]">Contact No.</span>
                  <span>:</span>
                  <span className="ml-1">{idCard?.MobileNo}</span>
                </div>
                <div className="flex">
                  <span className="font-bold w-[80px]">Blood Group</span>
                  <span>:</span>
                  <span className="ml-1">{idCard?.BloodGroup}</span>
                </div>
                <div className="flex">
                  <span className="font-bold w-[80px]">E-mail</span>
                  <span>:</span>
                ...
                <div className="flex">
                  <span className="font-bold w-[80px] flex-shrink-0">
                    Resi. Address
                  </span>
                  <span>:</span>
                ...
                <div className="flex">
                  <span className="font-bold w-[80px]">Valid Through</span>
                  <span>:</span>
                  <span className="ml-1">{idCard?.ValidDate}</span>
                </div>
                <div className="flex justify-between">
                  <div>
                    <span className="font-bold w-[80px] text-red-600">
                      Emergency Contact
                    </span>
                    <span>:</span>
                    ...
                    <div className="mb-1">
                      {idCard?.AuthoritySignature ? (
                        <img
                          ...
                          className="h-[32px] w-[75px] inline-block object-fill"
                        />
                      ) : (
                        <div className="h-[24px] w-[64px] border border-gray-300 flex items-center justify-center">
